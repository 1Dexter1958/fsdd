...
#
# Generated by export_simulation on Wed Mar 19 11:06:35 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './CLK_100M.sh' script.

./CLK_100M.sh -reset_run
...
./CLK_100M.sh -noclean_files

For more information on the script, please type './CLK_100M.sh -help'.
