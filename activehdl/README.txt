...
#
# Generated by export_simulation on Fri Mar 21 23:09:59 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './Input_Map.sh' script.

./Input_Map.sh -reset_run
...
./Input_Map.sh -noclean_files

For more information on the script, please type './Input_Map.sh -help'.
