...
#
# Generated by export_simulation on Wed Mar 19 11:23:51 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './FC_Weight.sh' script.

./FC_Weight.sh -reset_run
...
./FC_Weight.sh -noclean_files

For more information on the script, please type './FC_Weight.sh -help'.
